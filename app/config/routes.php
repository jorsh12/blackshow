...
if ($locales = Environment::get('locales')) {
	...
	Router::connect($template, array(), array('continue' => true, 'persist' => array(
			'locale',			
		)));
}
...
//Router::connect('/{:color}', array('Pages::home', 'color' => null), array( 'persist' => array('color')));
...
//Router::connect('/{:controller}/{:action}/{:color}', array('color' => null), array('persist' => array('color')));
