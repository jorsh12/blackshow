...
class PagesController extends \lithium\action\Controller {
	...
	public function we() {
		$texto = Texts::findOneBy(array('page' => 'we', 
			'language' => isset($this->request->params['locale']) ? $this->request->params['locale'] : 'default'));
		if ($texto == null){
			$texto = new Texts();
		}
		return $this->set(compact('texto'));
	}

	public function audio() {
		$texto = Texts::findOneBy(array('page' => 'audio',
			'language' => isset($this->request->params['locale']) ? $this->request->params['locale'] : 'default'));
		if ($texto == null){
			$texto = new Texts();
		}
	...
	public function lighting() {
		$texto = Texts::findOneBy(array('page' => 'lighting',
			'language' => isset($this->request->params['locale']) ? $this->request->params['locale'] : 'default'));
		if ($texto == null){
			$texto = new Texts();
		}
	...
	public function video() {
		$texto = Texts::findOneBy(array('page' => 'video',
			'language' => isset($this->request->params['locale']) ? $this->request->params['locale'] : 'default'));
		if ($texto == null){
			$texto = new Texts();
		}
	...
	public function maintence() {
		$texto = Texts::findOneBy(array('page' => 'maintence',
			'language' => isset($this->request->params['locale']) ? $this->request->params['locale'] : 'default'));
		if ($texto == null){
			$texto = new Texts();
		}
	...
	public function updateTexto() {
		...
		return $this->redirect('Pages::' . $this->request->data['page']);
	}
